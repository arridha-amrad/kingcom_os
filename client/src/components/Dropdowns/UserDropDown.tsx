...
import { ChevronDown, User, Pencil, Plus, LogOut, ShieldUser } from "lucide-react";
   ...
   return (
      <>
         <Menu>
            <MenuButton
               title={user.name}
               className="inline-flex items-center gap-2 rounded-md bg-foreground/5 px-3 py-1.5 text-sm/6 font-semibold"
            >
               <User />
